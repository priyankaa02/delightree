...
const ReviewTask = ({onClickList, total}) => {
  return (
        ...
        <TouchableOpacity
          ...
          <MyCard style={mainStyles.inSide}>
            <View style={mainStyles.inSideView}>
              ...
              <Text
                style={[
                  mainStyles.inSideTextFont,
                  {marginLeft: responsive.horizontal(140)},
                ]}>
                {total}
              </Text>
            </View>
          ...
          <MyCard style={mainStyles.inSide}>
            <View style={mainStyles.inSideView}>
              ...
              <Text
                style={[
                  mainStyles.inSideTextFont,
                  {marginLeft: responsive.horizontal(22)},
                ]}>
                Pending Application{' '}
              </Text>
              <Text
          ...
          <MyCard style={mainStyles.inSide}>
            <View style={mainStyles.inSideView}>
              <MaterialIcon
                ...
                color={colors.btn_blue}
              />
              <Text style={mainStyles.inSideTextFont}>
                Show All Auto-Renewals
              </Text>
            </View>
          </MyCard>
        </TouchableOpacity>
